...
namespace Service.Services.Hr.NewEmployee.Integration
{
    public interface IExternalNewEmployeeService : IBaseService<Entities.Entities.Hr.FullEmployee, AddMurasalatEmployeeDto, MurasalatEmployeeDto, Guid?>
    {
        ...
        /// <returns></returns>
        Task<IResult> GetManagerEmailByUnitIdAsync(string unitId);
        /// <summary>
        ...
        Task<IResult> GetEmployeesByUnitOrTeamIdAsync(string unitId);
        /// <summary>
        ...
        /// <returns></returns>
        Task<IResult> GetEmployeePhoneByIdAsync(string employeeId);
        /// <summary>
        ...
        /// <returns></returns>
        Task<IResult> GetEmployeeIdsByUnitIdAsync(string unitId, bool option);
        /// <summary>
        /// Get Murasalat Employees For Self Service
        /// </summary>
        /// <returns></returns>
        Task<IResult> GetAllMurasalatAsync();
