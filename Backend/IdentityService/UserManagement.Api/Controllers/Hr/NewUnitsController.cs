...
namespace UserManagement.Api.Controllers.Hr
{
    ...
    public class NewUnitsController : BaseController
    {
        ...
        public async Task<IResult> GetUnitOrTeamAsync(string id , UnitType unitType)
        {
        ...
        public async Task<IResult> GetSectionsByEmployeeSectionIdAsync(string sectionId)
        {
        ...
        [HttpPost]
        [Route("Add")]
        public async Task<IResult> PostAsync([FromBody] AddFullUnitDto dto)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public async Task<IResult> Update(AddFullUnitDto model)
        {
