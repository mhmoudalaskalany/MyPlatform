...
namespace Data.Migrations
{
    ...
    [Migration("20210915074242_AddCardEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Entities.Identity.Team", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Entities.Entities.Identity.Unit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Entities.Entities.Hr.Employee", b =>
                {
                    ...
                    b.HasOne("Entities.Entities.Identity.Team", "Team")
                        .WithMany("Employees")
                        .HasForeignKey("TeamId");

                    b.HasOne("Entities.Entities.Identity.Unit", "Unit")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Entities.Entities.Identity.Unit", b =>
                {
                    ...
                    b.HasOne("Entities.Entities.Identity.Unit", "Parent")
                        .WithMany("SubUnits")
                        .HasForeignKey("ParentId");
                });
