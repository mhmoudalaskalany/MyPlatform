...
namespace Service.Services.Hr.NewEmployee
{
    public interface INewEmployeeService : IBaseService<Entities.Entities.Hr.FullEmployee, AddMurasalatEmployeeDto, MurasalatEmployeeDto, Guid?>
    {
        ...
        /// <returns></returns>
        Task<IResult> GetEmployeeIdsByUnitIdAsync(string unitId);
        /// <summary>
        /// Get Unit Manager
        /// </summary>
        /// <param name="unitId"></param>
        ...
        /// <returns></returns>
        Task<IResult> GetUnitManagerAsync(string unitId, UnitType? unitType);
        /// <summary>
        /// Get By Id For View
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        Task<IResult> GetByIdForViewAsync(Guid id);
        /// <summary>
